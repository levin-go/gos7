...
type Client interface {
	...
	//read bytes
	ReadBytes(area int, dbNumber int,start int, size int)(buffer []byte ,err error)
	WriteBits(area int, dbNumber int,start int, status bool)(err error)
	WriteBytes(area int, dbNumber int,start int, buffer []byte)(err error)
	/*block*/
